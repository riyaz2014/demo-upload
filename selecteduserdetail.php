...
?>
	...
	<div class="container" style="padding:4rem ; box-shadow:none">
        ...
        <div>
            <table class="table table-striped table-condensed table-bordered table-success" style= "font-size:1.5rem">
                <tr style="color : dark;">
        ...
        <div class="row" style="display: flex; flex-direction:column ; align-items:center ;font-size:2.5rem; ">
        
            <div class="col-6">
        <label style="color : #6c757d;"><b>Transfer To:</b></label>
        <select name="to" class="form-control" required style="height:3.5rem ;font-size:2rem" >
        ...
        <div class="col-6">
            ...
            <input type="number" class="form-control" name="amount" required style="height:3.5rem ;font-size:2rem"> 
        </div>
